...
List<CoinGeckoModel> coinGeckoModelFromJson(String str) => List<CoinGeckoModel>.from(json.decode(str).map((x) => CoinGeckoModel.fromJson(x)));

String coinGeckoModelToJson(List<CoinGeckoModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
